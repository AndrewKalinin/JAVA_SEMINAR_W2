...
//Математика. Студент Петрова получил 4 по предмету Информатика.
...
public class task1_3 {
    ...
    public static void main(String[] args) throws Exception {
        String [] arrayData = lib.ReadLineFromFile("dataForTask1_3.txt");
    ...
    public static StringBuilder PrintLine(String line) {
        ...
        String [] listName = {"Student ", " received a grade ", " in subject "};
        for (int i =0; i < arrayData.length; i++) {
